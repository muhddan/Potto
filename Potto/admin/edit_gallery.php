<?php
    ...
    $sql_productInformation = "SELECT * FROM gallery WHERE gallery_id='$productID'";
    ...
    if(isset($_POST["submit"])){
        ...
        if(!empty($target_file)){
            ...
            if(empty($submitErr) && !empty($target_file)){
                if(move_uploaded_file($_FILES['file']['tmp_name'],$real_target_dir)){
                    ...
                    $sql_updateData = "UPDATE gallery SET picture = '$new_image_name' WHERE gallery_id='$productID'";
        ...
        if(!empty($productName)){
            ...
            $sql_checkDupName = "SELECT * FROM gallery WHERE name='$productName' AND gallery_id != '$productID'";
            ...
            if(empty($submitErr)){
                $sql_updateData = "UPDATE gallery SET name = '$productName' WHERE gallery_id='$productID'";
        ...
        if(!empty($productPrice)){
            $sql_updateData = "UPDATE gallery SET price = '$productPrice' WHERE gallery_id='$productID'";
        ...
        if(!empty($productDescription)){
            $sql_updateData = "UPDATE gallery SET description = '$productDescription' WHERE gallery_id='$productID'";
        ...
        header("location: ".$thisPage."?productID=".$productID."");
        exit;
    }
?>
...
<body class="body">
    <div class="sidebar">
        ...
        <a class="active" href="gallary.php"><i class='bx bxs-info-circle' ></i> Gallery Info</a>
        <a href="gallary_create.php"><i class='bx bx-book-add' ></i> Gallery Create</a>
    ...
    <div class="content">
        <div style="width: 70%; margin: auto;">
            <br>
            <h1 style="text-align: center;">Edit Gallery : (<?php echo $productName; ?>)</h1>
                    ...
                    <div class="right-create-product-container">
                        <div class="avatar-upload">
                            ...
                            <div style="overflow: hidden;" class="avatar-preview">
                                <img src="../resource/gallery_pic/<?php echo $row_productInformation['picture']; ?>" id="previewImg" style="width: 200px; height: 200px;">
                            </div>
                        </div>

                        <label for="product-name">Gallery Name</label>
                        <input type="text" value="<?php echo $productName; ?>" id="product-name" name="product-name">
                        <br>
